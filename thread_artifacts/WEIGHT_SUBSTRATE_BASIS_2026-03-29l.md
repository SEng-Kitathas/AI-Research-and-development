...
## New inspiration seam

### RegimeCache (inspiration only)
Stable expensive routing/scoring decisions may be reusable across nearby steps.
This is a native decision-reuse idea, not imported sparse attention machinery.
...
- Cheap recurrence is a real branch
- Reuse stable decisions only when calibration shows it is safe